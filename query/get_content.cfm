...
<cfquery name="GET_MY_POSITION_CAT_USER_GROUP" datasource="#DSN#">
	SELECT POSITION_CAT_ID,USER_GROUP_ID FROM EMPLOYEE_POSITIONS WHERE POSITION_CODE = <cfqueryparam cfsqltype="cf_sql_integer" value="1">
</cfquery>
	...
	WHERE 	
		...
		<cfif isdefined("attributes.cntid") and len(attributes.cntid)>
            <cfif listlen(attributes.cntid) eq 1>
            	 C.CONTENT_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.cntid#">
            <cfelse>
