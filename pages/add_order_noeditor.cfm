    	...
    	<div class="row">
		    ...
		    <div class="col col-3 col-md-4 col-sm-12" type="column" index="1" sort="true">
		        <div class="form-group require" id="item-order_head">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='1408.Başlık'></label>
		        ...
		        <div class="form-group require" id="item-company">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='107.Cari Hesap'></label>
		            <div class="col col-8 col-sm-12">
			            <div class="input-group">
		                    ...
		                    <span class="input-group-addon btnPointer icon-ellipsis" onClick="windowopen('#request.self#?fuseaction=objects.popup_list_pars#str_linke_ait#&field_card_payment_id=form_basket.card_paymethod_id&function_name=fill_country<cfif session.ep.isBranchAuthorization>&is_store_module=1</cfif>&select_list=2,3&call_function=add_general_prom()-check_member_price_cat()-show_member_button()','list','popup_list_all_pars');"></span>
		                </div>
		            </div>                
		        </div>
		        ...
		        <div class="form-group require" id="item-member_name">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='166.Yetkili'></label>
		            <div class="col col-8 col-sm-12">
		        ...
		        <div class="form-group require" id="item-order_employee">
		            <label class="col col-3 col-sm-12"><cf_get_lang no='357.Satış Çalışanı'></label>
		            <div class="col col-8 col-sm-12">
			            <div class="input-group">
		                    ...
		                    <cfif session.ep.isBranchAuthorization>
		                        <span class="input-group-addon btnPointer icon-ellipsis" onClick="windowopen('#request.self#?fuseaction=objects.popup_list_positions&field_emp_id=form_basket.order_employee_id&field_name=form_basket.order_employee&is_store_module=1&select_list=1','list','popup_list_positions');"></span>
							<cfelse>
		                        <span class="input-group-addon btnPointer icon-ellipsis" onClick="windowopen('#request.self#?fuseaction=objects.popup_list_positions&field_emp_id=form_basket.order_employee_id&field_name=form_basket.order_employee&select_list=1','list','popup_list_positions');"></span>
		                    </cfif>
		                </div>
		            </div>                
		        </div>
		        <div class="form-group require" id="item-sales_member">
		            <label class="col col-3 col-sm-12"><cf_get_lang no='102.Satış Ortağı'></label>
		            <div class="col col-8 col-sm-12">
			            <div class="input-group">
		                	...
		                	<input type="text" name="sales_member" id="sales_member" placeholder="<cfoutput>#getLang('sales',102)#</cfoutput>" value="<cfif isdefined('attributes.sales_member') and len(attributes.sales_member)>#attributes.sales_member#</cfif>" onFocus="AutoComplete_Create('sales_member','MEMBER_NAME,MEMBER_PARTNER_NAME','MEMBER_PARTNER_NAME2,MEMBER_NAME2','get_member_autocomplete','\'1,2\',0,0,0','PARTNER_CODE,MEMBER_TYPE','sales_member_id,sales_member_type','','3','250');" autocomplete="off">
		                    <cfif session.ep.isBranchAuthorization>
		                        <span class="input-group-addon btnPointer icon-ellipsis" onClick="windowopen('#request.self#?fuseaction=objects.popup_list_pars&is_rate_select=1&field_id=form_basket.sales_member_id&field_name=form_basket.sales_member&field_type=form_basket.sales_member_type&is_store_module=1&select_list=2,3','list','popup_list_pars');"></span>
		                    <cfelse>
		                        <span class="input-group-addon btnPointer icon-ellipsis" onClick="windowopen('#request.self#?fuseaction=objects.popup_list_pars&is_rate_select=1&field_id=form_basket.sales_member_id&field_name=form_basket.sales_member&field_type=form_basket.sales_member_type&select_list=2,3','list','popup_list_pars');"></span>
		                    </cfif>
		                </div>
		            </div>                
		        </div>
		        <div class="form-group require" id="item-ref_no">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='1382.Referans No'></label>
		            <div class="col col-8 col-sm-12">
		        ...
		        <div class="form-group require" id="item-offer_head">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='133.Teklif'></label>
		            <div class="col col-8 col-sm-12">
		            	<div class="input-group">
		                    ...
		                    <span class="input-group-addon btnPointer icon-ellipsis" onClick="windowopen('#request.self#?fuseaction=sales.popup_list_offers&field_offer_id=form_basket.offer_id&field_offer_number=form_basket.offer_head&field_member_id=form_basket.partner_id&field_member_name=form_basket.member_name&field_member_company=form_basket.company&field_member_company_id=form_basket.company_id&field_member_consumer_id=form_basket.consumer_id','list');"></span>
		                </div>
		            </div>                
		        </div>
		        <cfif session.ep.our_company_info.subscription_contract eq 1>
		        	<div class="form-group require" id="item-sales_add_option">
		                <label class="col col-3 col-sm-12"><cf_get_lang no ='340.Satış Özel Tanım'></label>
		                <div class="col col-8 col-sm-12">
				...
				<div class="form-group" id="item-cf_wrk_add_info">
					<label class="col col-3 col-xs-12"><cfoutput>#getLang('main',398)#</cfoutput></label>
		    ...
		    <div class="col col-3 col-md-4 col-sm-12" type="column" index="2" sort="true">
		        <div class="form-group require" id="item-order_date">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='1704.Sipariş Tarihi'></label>
		            <div class="col col-8 col-sm-12">
			            <div class="input-group">
			                <cfsavecontent variable="message"><cf_get_lang no='246.Sipariş Tarihi Girmelisiniz'> !</cfsavecontent>
		                    <cfinput type="text" name="order_date" id="order_date" required="yes" value="#attributes.order_date#" validate="#validate_style#" message="#message#" maxlength="10" readonly="yes">
		        ...
		        <div class="form-group require" id="item-ship_date">
		            <label class="col col-3 col-sm-12"><cf_get_lang no='32.Sevk Tarihi'></label>
		            <div class="col col-8 col-sm-12">
		            	<div class="input-group">
		                	<cfsavecontent variable="message"><cf_get_lang no='93.Sevk Tarihi Girmelisiniz'>!</cfsavecontent>
		        ...
		        <div class="form-group require" id="item-deliverdate">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='233.Teslim Tarihi'></label>
		            <div class="col col-8 col-sm-12">
		                <div class="input-group">
		        ...
		        <div class="form-group require" id="item-deliver_dept_name">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='1351.Depo'></label>
		            <div class="col col-8 col-sm-12">
		        ...
		        <div class="form-group require" id="item-ship_method_name">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='1703.Sevk Yöntemi'></label>
		            <div class="col col-8 col-sm-12">
			            <div class="input-group">
		                	...
		                	<input type="text" name="ship_method_name" placeholder="<cfoutput>#getLang('main',1703)#</cfoutput>" id="ship_method_name" value="<cfif isdefined("attributes.ship_method_name")><cfoutput>#attributes.ship_method_name#</cfoutput><cfelseif isdefined("ship_method") and len(ship_method)>#ship_method#</cfif>" onFocus="AutoComplete_Create('ship_method_name','SHIP_METHOD','SHIP_METHOD','get_ship_method','','SHIP_METHOD_ID','ship_method_id','','3','125');" autocomplete="off">
		        ...
		        <div class="form-group require" id="item-ship_address">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='1037.Teslim Yeri'></label>
		            <div class="col col-8 col-sm-12">
		            	<div class="input-group">
		        ...
		        <div class="form-group require" id="item-country_id1">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no ='807.Ulke'></label>
		            <div class="col col-8 col-sm-12">
		    ...
		    <div class="col col-3 col-md-4 col-sm-12" type="column" index="3" sort="true">
		        <div class="form-group require" id="item-order_status">
                ...
                <div class="form-group require" id="item-reserved">
		            <div class="col col-12 col-sm-12">
						<label><cf_get_lang no ='383.Stok Rezerve Et'><input type="checkbox" name="reserved" id="reserved" value="1" <cfif (isdefined("attributes.reserved") and attributes.reserved eq 1) or not isdefined('attributes.reserved')>checked</cfif> onClick="check_reserved_rows();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
		            </div>                
		        </div>				
		        <div class="form-group require" id="item-process_stage">
		          <label class="col col-3 col-sm-12"><cf_get_lang_main no="1447.Süreç"></label>
		            <div class="col col-8 col-sm-12">
		                <cf_workcube_process is_upd='0' process_cat_width='125' is_detail='0'>
		            </div>                
		        </div> 
		        <div class="form-group require" id="item-paymethod">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='1104.Ödeme Yontemi'></label>
		            <div class="col col-8 col-sm-12">
			            <div class="input-group">
		        ...
		        <div class="form-group require" id="item-commethod_id">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='731.İletişim'></label>
		            <div class="col col-8 col-sm-12">
		        ...
		        <div class="form-group require" id="item-project_head">
		          <label class="col col-3 col-sm-12"><cf_get_lang_main no='4.Proje'></label>
		            <div class="col col-8 col-sm-12">
			            <div class="input-group">
		                	...
		                	<input type="text" placeholder="<cfoutput>#getLang('main',4)#</cfoutput>" name="project_head" id="project_head" value="<cfif isdefined('attributes.project_id') and len(attributes.project_id)>#get_project_name(attributes.project_id)#</cfif>" onFocus="AutoComplete_Create('project_head','PROJECT_ID,PROJECT_HEAD','PROJECT_HEAD','get_project','','PROJECT_ID','project_id','form_basket','3','200')"autocomplete="off">
		        ...
		        <div class="form-group require" id="item-sales_zone_id">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no ='247.Satis bolgesi'></label>
		            <div class="col col-8 col-sm-12">
		    ...
		    <div class="col col-3 col-md-4 col-sm-12" type="column" index="4" sort="true">
		        <div class="form-group require" id="item-detail">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='217.Açıklama'></label>
		            <div class="col col-8 col-sm-12">
		        ...
		        <div class="form-group require" id="item-ref_company">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='1372.Referans'></label>
		            <div class="col col-8 col-sm-12">
			            <div class="input-group">
		                	...
		                	<input type="text" name="ref_company" placeholder="<cfoutput>#getLang('main',1372)#</cfoutput>" id="ref_company" value="<cfif isdefined('attributes.ref_company') and len(attributes.ref_company)>#attributes.ref_company#</cfif>" onFocus="AutoComplete_Create('ref_company','MEMBER_NAME,MEMBER_PARTNER_NAME','MEMBER_NAME2,MEMBER_PARTNER_NAME2','get_member_autocomplete','\'1,2\'','COMPANY_ID,MEMBER_TYPE,PARTNER_CODE,MEMBER_PARTNER_NAME2','ref_company_id,ref_member_type,ref_member_id,ref_member','','3','250');" autocomplete="off">
		                    <span class="input-group-addon btnPointer icon-ellipsis" onClick="windowopen('#request.self#?fuseaction=objects.popup_list_all_pars&is_rate_select=1&field_partner=form_basket.ref_member_id&field_consumer=form_basket.ref_member_id&field_comp_id=form_basket.ref_company_id&field_comp_name=form_basket.ref_company&field_name=form_basket.ref_member&field_type=form_basket.ref_member_type<cfif session.ep.isBranchAuthorization>&is_store_module=1</cfif>&select_list=7,8','list','popup_list_all_pars');"></span>
		                </div>
		            </div>                
		        </div> 
		        ...
		        <cfif session.ep.our_company_info.subscription_contract eq 1>
		            <div class="form-group require" id="item-camp_id">
		                <label class="col col-3 col-sm-12"><cf_get_lang_main no='1705.Abone No'></label>
		                <div class="col col-8 col-sm-12">
		        ...
		        <div class="form-group require" id="item-camp_name">
		            <label class="col col-3 col-sm-12"><cf_get_lang_main no='34.Kampanya'></label>
		            <div class="col col-8 col-sm-12">
			            <div class="input-group">
			                <cfoutput>
			                    <input type="hidden" name="camp_id" id="camp_id" value="">
		                        <input type="text" name="camp_name" id="camp_name" value="">
		                        <span class="input-group-addon btnPointer icon-ellipsis" onClick="windowopen('#request.self#?fuseaction=objects.popup_list_campaigns&field_id=form_basket.camp_id&field_name=form_basket.camp_name','list');"></span>
		                    </div>
		                </cfoutput>
		            </div>                
		        </div> 
