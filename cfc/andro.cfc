...
<cfreturn Replace(SerializeJSON(returnObj),'//','')>
     ...
     <cffunction  name="setData"  httpMethod="post" access="remote" returntype="any" returnformat="json"
...
<cffunction  name="get_Processcats" httpMethod="GET" access="remote" returntype="any" returnformat="json"
                produces="application/json" >
